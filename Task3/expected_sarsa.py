...
for episode in range(0, 500):
    ...
    while not done:            
        ...
        next_state = convert_state_tuple(observation)
        next_action = epsilon_greedy(action_value[next_state])

        # TODO: Implement Expected SARSA here! (this might be a little bit tricky!)
        ################# YOUR CODE ################# 
        ...
        # Hint: get probability of choosing the non-greedy option and
        # probability of choosing the greedy option!!!
        # (Don't forget to account for actions having an equal, maximum
        # Q-values. so like if actions have the value up=5, down=5, right=2, left=-1
        # for a given state, then you have two greedy options)
